            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form method="post" action="{{ route('tambah_laporan') }}" enctype="multipart/form-data">
                    ...
                    <select class="form-select" name="jenis_kekerasan_seksual" id="jenis_kekerasan_seksual">
                        ...
                        <option value="Ujaran diskriminatif atau melecehkan Korban">Ujaran diskriminatif atau melecehkan
                            Korban</option>
                        <option value="Memperlihatkan alat kelamin tanpa izin">Memperlihatkan alat kelamin tanpa izin
                        </option>
                        ...
                        <option value="Mengambil atau mengedarkan foto/video seksual">Mengambil atau mengedarkan
                            foto/video seksual</option>
                        ...
                        <option value="Membiarkan Kekerasan Seksual terjadi">Membiarkan Kekerasan Seksual terjadi
                        </option>
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="narasipelapor" name="cerita_peristiwa"
                            id="floatingTextarea" style="height: 150px;">{{ old('cerita_peristiwa') }}</textarea>
                    </div>
                    ...
                    <div class="form-floating mt-3">
                        <select class="form-select" id="hasDisability" name="memiliki_disabilitas"
                            aria-label="Floating label select example" onchange="showDisabilityInput()">
                            <option value="" disabled {{ old('memiliki_disabilitas')===null ? 'selected' : '' }}>pilih
                                salah satu</option>
                            <option value="tidak" {{ old('memiliki_disabilitas')==='tidak' ? 'selected' : '' }}>
                                Tidak</option>
                            <option value="memiliki" {{ old('memiliki_disabilitas')==='memiliki' ? 'selected' : '' }}>
                                Memiliki</option>
                        </select>
                    ...
                    <div id="disabilityInput"
                        ...
                        <input type class="form-control" placeholder="Deskripsi disabilitas"
                            name="deskripsi_disabilitas" id="deskripsi_disabilitas" style="height: 80px;">{{
                        old('deskripsi_disabilitas') }}</input>
                    </div>
                    ...
                    <div class="form-floating mb-3 mt-3">
                        <select class="form-select" id="statusterlapor" name="status_terlapor"
                            ...
                            <option value="Pendidik" {{ old('status_terlapor')==='Pendidik' ? 'selected' : '' }}>
                                Pendidik</option>
                            <option value="tenaga_kependidikan" {{ old('status_terlapor')==='tenaga_kependidikan'
                                ? 'selected' : '' }}>Tenaga
                                Kependidikan</option>
                            <option value="warga_kampus" {{ old('status_terlapor')==='warga_kampus' ? 'selected' : ''
                                }}>Warga Kampus</option>
                            <option value="masyarakat_kampus" {{ old('status_terlapor')==='masyarakat_kampus'
                                ? 'selected' : '' }}>Masyarakat Umum
                            </option>
                        </select>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="alasan_pengaduan[]"
                                    ...
                                    {{ in_array('Saya seorang saksi yang khawatir dengan keadaan korban',
                                    old('alasan_pengaduan', [])) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="alasan_pengaduan[]"
                                    id="bantuanPemulihan" value="Saya seorang korban yang memerlukan bantuan pemulihan"
                                    {{ in_array('Saya seorang korban yang memerlukan bantuan pemulihan',
                                    old('alasan_pengaduan', [])) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="alasan_pengaduan[]"
                                    id="tindakTegasLaporan" value="Saya ingin perguruan tinggi menindak tegas terlapor"
                                    {{ in_array('Saya ingin perguruan tinggi menindak tegas terlapor',
                                    old('alasan_pengaduan', [])) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="alasan_pengaduan[]"
                                    ...
                                    {{ in_array('Saya ingin satuan tugas mendokumentasikan kejadiannya, meningkatkan
                                    keamanan perguruan tinggi dari kekerasan seksual, dan memberi perlindungan bagi
                                    saya', old('alasan_pengaduan', [])) ? 'checked' : '' }}>
