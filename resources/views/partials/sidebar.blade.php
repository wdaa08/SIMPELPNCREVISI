    ...
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            @if (auth()->user()->role_id == 1)
                <a href="{{ route('s.datapelaporan') }}" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Data Pelaporan</a>
            @endif
            
            <a href="form.html" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Chatbot</a>
            ...
            <a href="{{ route('s.datapelaporan') }}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Widgets</a>
