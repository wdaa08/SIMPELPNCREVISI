...
<div class="container my-4">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-link edit-respon-btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="{{ $pelaporan->id }}">
                                    Ubah
                                </button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-link btn-primary detail-pelaporan-btn" data-bs-toggle="modal"
    ...
    <div class="modal fade" id="modalDetailPelaporan" tabindex="-1" aria-labelledby="modalDetailPelaporanLabel" aria-hidden="true">
