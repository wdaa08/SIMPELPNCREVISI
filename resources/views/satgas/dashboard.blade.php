        ...
        <div class="row g-4">
            ...
            <div class="col-sm-4">
                <div class="bg-light rounded p-4">
                    ...
                    <canvas id="laporanPerProdiChart" width="400" height="300"></canvas>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="bg-light rounded p-4">
                    ...
                    <div id="laporanPerBulanInfo" class="mt-3">
                        <!-- Tempat untuk menampilkan informasi per bulan -->
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var myChart = new Chart(ctx, {
        type: 'line',  // Menggunakan chart jenis garis
        data: {
            labels: labels,
            datasets: [{
                label: 'Total Laporan',
                ...
                label: 'Rata-rata',
                data: Array(labels.length).fill(dataTotal.reduce((a, b) => a + b, 0) / dataTotal.length),
    ...
    // Menampilkan informasi per bulan
    var infoDiv = document.getElementById('laporanPerBulanInfo');
    laporanPerBulanData.forEach(function(item, index) {
        var p = document.createElement('p');
        p.textContent = `\u2022 ${labels[index]}: ${item.total} laporan`;
